...
namespace OpenRA
{
	...
	public sealed class Order
	{
		...
		{
			return new Order(grouped.OrderString, subject, grouped.Target, grouped.TargetString, grouped.Queued, grouped.ExtraActors,
							 grouped.ExtraLocation, grouped.ExtraData, grouped.GroupedActors);
		}
