...
namespace OpenRA.Mods.Common.Terrain
{
	...
	public class DefaultTerrain : ITemplatedTerrainInfo, ITerrainInfoNotifyMapCreated
	{
		...
		public TerrainTileInfo GetTerrainInfo(TerrainTile tile)
		{
			return Templates[tile.Type][tile.Index];
		}

		public bool TryGetTerrainInfo(TerrainTile tile, out TerrainTileInfo info)
		{
		...
		TerrainTileInfo ITerrainInfo.GetTerrainInfo(TerrainTile tile) {	return GetTerrainInfo(tile); }
		bool ITerrainInfo.TryGetTerrainInfo(TerrainTile tile, out TerrainTileInfo info) { return TryGetTerrainInfo(tile, out info); }
